...
public class InstructorRepository {
    ...
    public List<LetterGrades> getGrades(long section_id, long course_id, String semester, int year){
        return  jdbcTemplate.query("SELECT u.user_id, u.firstname, u.lastname, t.final_grade " +
                ...
                "WHERE sec.section_id = ? AND sec.course_id = ? AND  t.semester= ? AND t.year= ?; ",new Object[] {section_id,course_id, semester, year}, new InstructorGradeMapper());
    }
    ...
    public List<TeachingAssistantList> getTeachingAssistants(long course_id, long instructor_id){
        return  jdbcTemplate.query("SELECT ta.ta_id, u.firstname, u.lastname " +
                ...
                "WHERE sec.course_id = ? AND i.instructor_id=? ; ",new Object[] {course_id, instructor_id}, new InstructorAssignMapper());
    }
